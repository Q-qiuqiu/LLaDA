...
def main():
    ...
    parser.add_argument(
        "--side-output",
        type=str,
        default="/home/yzx/LLaDA/yzx_test/value_outputs/side1.xlsx",
    )
    
    parser.add_argument(
        "--output-file",
        type=str,
        default="/home/yzx/LLaDA/yzx_test/denoise_value_log1.txt",
    )
    parser.add_argument(
        "--output-prefix",
        type=str,
        default="/home/yzx/LLaDA/yzx_test/value_outputs/denoise_value1",
    )
    parser.set_defaults(
